...
class TestFrequencyResponse(unittest.TestCase):
    ...
    def test_acceleration(self):
        ...
        # subcase 3
        # frequency 300Hz
        acceleration_2019_sc3 = [-5.901583E-02 + 1j*5.758094E-06,
        ...
        self.assertListAlmostEqual(accelerations_1[2019][295], acceleration_2019_sc3)
        self.assertListAlmostEqual(accelerations_2[2019][295], acceleration_2019_sc3)
        self.assertListAlmostEqual(accelerations_3[2019][295], acceleration_2019_sc3, delta=1.0e-3)
        self.assertListAlmostEqual(accelerations_4[2019][295], acceleration_2019_sc3, delta=1.0e-3)
    ...
    def assertListAlmostEqual(self, list1, list2, delta=1.0e-6):
        for a, b in zip(list1, list2):
            self.assertAlmostEqual(a, b, delta=delta)

    def test_frequencies(self):
        self.assertListAlmostEqual(self.parser_sort1_mp.get_frequencies(1), list(range(5, 301)), 1.0e-4)
        self.assertListAlmostEqual(self.parser_sort2_mp.get_frequencies(1), list(range(5, 301)), 1.0e-4)
        self.assertListAlmostEqual(self.parser_sort1_ri.get_frequencies(1), list(range(5, 301)), 1.0e-4)
        self.assertListAlmostEqual(self.parser_sort2_ri.get_frequencies(1), list(range(5, 301)), 1.0e-4)
